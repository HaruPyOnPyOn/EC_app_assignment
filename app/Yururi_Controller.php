...
require_once 'Yururi_Error.php';
require_once 'Yururi_ActionClass.php';
require_once 'Yururi_ActionForm.php';
require_once 'Yururi_ViewClass.php';
require_once 'Yururi_UrlHandler.php';

/**
 *  Yururi application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Yururi
 */
class Yururi_Controller extends Ethna_Controller
{
    /**#@+
     *  @access protected
     */
    ...
    public $class = array(
        ...
        'form'          => 'Yururi_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'view'          => 'Yururi_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Yururi_UrlHandler',
    );
